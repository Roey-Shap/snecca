...
function autotile_static(tileset, sprite_grid, color){
	...
	for (var w = 0; w < image_xscale; w++) {
		for (var h = 0; h < image_yscale; h++) {
			...
			var tile_index = sprite_grid[# w, h];
			var xcoord = (tile_index) % 5;
			var ycoord = floor((tile_index) / 5);
			//var xcoord = sprite_grid[# w, h];
			//var ycoord = sprite_grid[# w+image_xscale, h];
			
			draw_sprite_part_ext(tileset, 0, xcoord*32, ycoord*32, 32, 32, 
									rx, ry, 1, 1, color, image_alpha);	
	...
	//	var xcoord = (tile_index) % 5;
	//	var ycoord = floor((tile_index) / 5);
	//	draw_sprite_part_ext(tileset, 0, (xcoord)*32, (ycoord)*32, 32, 32, rx, ry, 1, 1, color, image_alpha);	
